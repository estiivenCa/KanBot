...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `😎 Su video`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch (E1) {
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `😎 Su video`, thumbnail: await fetch(n4) }, { quoted: m })
} catch (E3) {
